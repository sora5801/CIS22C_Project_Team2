...
inline size_t nearest_power_of_2(size_t n)
{
	int count = 0;
	while (n)
	{
...
public:
	vector() :vector_pointer(nullptr), vector_size(0), vector_capacity(0) {}  // Default Constructor

	vector(const vector& other) :vector_pointer(nullptr), vector_size(0), vector_capacity(0)  // Copy Constructor
	{
	...
	friend void swap(vector &a, vector &b)  // Copy and Swap Idiom ...
	{
